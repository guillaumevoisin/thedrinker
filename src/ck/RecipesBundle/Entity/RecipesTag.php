...
/**
 * @ORM\Entity(repositoryClass="ck\RecipesBundle\Entity\RecipesTagRepository")
 * @ORM\Table(name="recipes_tag")
 */
class RecipesTag
{
    /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity="ck\RecipesBundle\Entity\Recipe", mappedBy="tags")
     */
    private $recipes;
